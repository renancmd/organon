...
function Sidebar() {
    return (
        <aside className="fixed inset-y-0 left-0 z-40 hidden w-20 flex-col border-r bg-white dark:bg-gray-950 dark:border-gray-800 md:flex">
            ...
            {/* O ícone de perfil na parte inferior fica ativo nesta página */}
            <nav className="mt-auto flex flex-col items-center gap-4 px-2 sm:py-5">
                 <a href="/perfil" className="flex h-9 w-9 items-center justify-center rounded-lg bg-gray-100 text-gray-900 transition-colors hover:text-gray-900 dark:bg-gray-800 dark:text-gray-50 dark:hover:text-gray-50"><CircleUserRound className="h-5 w-5" /></a>
            </nav>
        </aside>
    );
}
