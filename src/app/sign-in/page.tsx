// app/login/page.tsx
// Página de Login para o aplicativo Organon.
            ...
            <Card>
                ...
                <CardContent className="space-y-4">
                    <div className="space-y-2">
                     ...
                     <div className="space-y-2">
                        <div className="flex items-center justify-between">
                             ...
                             <a href="lost-password" className="text-sm font-medium text-blue-600 hover:underline dark:text-blue-500">
                                Esqueci minha senha
                            </a>
                        </div>
                 ...
                 <div className="p-6 pt-0 text-center text-sm text-gray-600 dark:text-gray-400">
                    Não tem uma conta?{' '}
                    <a href="/sign-up" className="font-medium text-blue-600 hover:underline dark:text-blue-500">
                        Registre-se
                    </a>
                </div>
            </Card>
